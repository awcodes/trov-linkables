...
use App\Filament\Resources\Trov\LinkSetResource\RelationManagers;
use App\Filament\Resources\Trov\LinkSetResource\Pages\EditLinkSet;
use App\Filament\Resources\Trov\LinkSetResource\Pages\ListLinkSets;
use App\Filament\Resources\Trov\LinkSetResource\Pages\CreateLinkSet;
...
class LinkSetResource extends Resource
{
    ...
    public static function getFormSchema(): array
    {
        return [
            Select::make('section')
                ->options(config('trov-linkables.sections'))
                ->required()
                ->columnSpan('full'),
            Repeater::make('links')
                ->schema([
